...
from dados.einhell.listaProdutosEinhell import listaProdutosEinhell
from dados.wurth.listaProdutosWurth import listaProdutosWurth
...
# faz rota sistemica wurth #
navegador.find_element('xpath', '/html/body/center/div[2]/div/ul/li[6]/a').click()
time.sleep(1)
...
linhaItem = 1
while itemPDF <= 100:
    for item in listaProdutosWurth.listaProdutosBloco2:
